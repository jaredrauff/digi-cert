...
const Dropdown: React.FC<DropdownProps> = ({ options, value, onChange }) => {
    ...
    return (
        <div className="relative w-full">
            <button className="disabled:pointer-events-none disabled:opacity-50 relative py-3 px-4 pe-9 flex text-nowrap w-full cursor-pointer bg-white rounded-lg text-start text-sm before:absolute before:inset-0 before:z-[1] dark:bg-slate-900 dark:text-gray-400 dark:focus:outline-none" onClick={() => setIsOpen(!isOpen)}>
